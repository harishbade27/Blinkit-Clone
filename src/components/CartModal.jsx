...
const CartModal = ({ isOpen, toggleCart }) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 right-0 w-80 h-full z-50 transform transition-transform duration-300 shadow-lg 
          ...
          {cart.length === 0 ? (
            ...
            <div className="flex-1 overflow-y-auto">
              {cart.map((item) => (
                <div
                  key={item.id}
                  className="flex justify-between items-center mb-3 border-b border-gray-200 dark:border-gray-700 pb-2"
                >
